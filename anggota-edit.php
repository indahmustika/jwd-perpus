...
<body>
	...
	<div class="container">
		...
		<div class="card shadow">
			...
			<div class="card-body">
				<form action="anggota-update.php" method="POST">
					<?php foreach($rows as $valueget): ?>
						...
						<div class="row">
							...
							<div class="col-sm-8"><input type="text" name="nama" value="<?php echo $valueget[1]; ?>" class="form-control"></div>
						</div>
						<div class="row">
							<div class="col-sm-3" style="margin-bottom: 30px;">Alamat</div>
							<div class="col-sm-8"><input type="text" name="alamat" value="<?php echo $valueget[2]; ?>" class="form-control"></div>
						</div>
						<div class="row">
							<div class="col-sm-3" style="margin-bottom: 30px;">Telepon</div>
							<div class="col-sm-8"><input type="text" name="telepon" value="<?php echo $valueget[3]; ?>" class="form-control"></div>
						</div>
						<div class="row">
							<div class="col-sm-3" style="margin-bottom: 30px;">Email</div>
							<div class="col-sm-8"><input type="text" name="email" value="<?php echo $valueget[4]; ?>" class="form-control"></div>
						</div>
						<div class="row">
